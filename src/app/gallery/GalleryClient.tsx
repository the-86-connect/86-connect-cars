...
export function GalleryClient() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-primary)]">
      <div className="mx-auto max-w-[1400px] px-4 py-12 lg:py-16">
        {/* Back link */}
        <Link
          href="/"
          className="mb-6 inline-flex items-center gap-1.5 text-sm text-[var(--text-secondary)] hover:text-brand-500 transition-colors"
        >
          &larr; Back to Home
        </Link>
        ...
        >
          <SectionHeading
            eyebrow="Our Gallery"
            title="Photos & Videos"
            subtitle="Explore our collection of vehicle photos and videos from China exports."
          />
        </motion.div>
          ...
          <div className="inline-flex rounded-full bg-[var(--bg-elevated)] p-1">
            {(["all", "photo", "video"] as MediaType[]).map((tab) => (
              <button
                ...
                className={`flex items-center gap-1.5 rounded-full px-4 py-1.5 text-xs font-medium transition-all duration-300 sm:px-5 sm:py-2 sm:text-sm ${
                  activeTab === tab
