    ...
    >
      ...
      <div className="flex flex-col gap-2 p-4">
        ...
        <button
          type="button"
          onClick={onInquiry}
          className="mt-2 inline-flex w-full items-center justify-center gap-1.5 rounded-full border border-[var(--border-color)] bg-[var(--bg-elevated)] px-4 py-2 text-xs font-medium text-[var(--text-primary)] transition-all hover:border-emerald-400 hover:bg-emerald-50 hover:text-emerald-700 dark:hover:bg-emerald-900/20 dark:hover:text-emerald-400"
          aria-label={`Inquiry about ${vehicle.brand} ${vehicle.model}`}
        >
          <svg viewBox="0 0 24 24" className="h-3.5 w-3.5 text-emerald-500" fill="currentColor" aria-hidden="true">
